...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $query ="INSERT INTO cv(p_name,p_pic,cv_content) VALUES ('$name','$file_name','$cv')";
...
<section>
  <form  method="POST" action=<?php echo $_SERVER['PHP_SELF'];?> enctype="multipart/form-data">
    ...
    <input type="text" name="w_name" placeholder="Your name..">
    ...
    <label > Cv </label><br>
      <textarea type="text" name="cv_con" rows="50" cols="100"></textarea><br>
